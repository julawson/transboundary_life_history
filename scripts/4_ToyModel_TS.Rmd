...
for(t in 1:timesteps) {
  ...
  # Larval contribution t+1
  a_t1_larval = new_a(y_b = y_b_t, y_a = y_a_t)
  b_t1_larval = new_b(y_a = y_a_t, y_b = y_b_t)
  
  # Adult contribution t+1
  a_t1_adult = adult_a(e_b = e_b_t, e_a = e_a_t)
  b_t1_adult = adult_b(e_a = e_a_t, e_b = e_b_t)
