...
# Empty Data Frame
all_results <- data.frame(D_ba = numeric(), e_a = numeric(), e_b = numeric(), a_1 = numeric(), b_1 = numeric(), diff_a = numeric(), diff_b = numeric())
...
#Plot for Patch A if D_ba ranges from 0 (no dispersal) to 1 (all larvae move from patch B to patch A)
ggplot(all_results, aes(x = e_b, y = b_1, color = as.factor(D_ba))) +
  geom_line() +
  geom_abline(slope = 1, intercept = 0, linetype = "dashed", color = "red") +
